...
export const DELETE_KIDS_DATA_REQUEST = "DELETE_WOMEN_DATA_REQUEST";
export const DELETE_KIDS_DATA_SUCCESS = "DELETE_WOMEN_DATA_SUCCESS";
export const DELETE_KIDS_DATA_FAILURE = "DELETE_WOMEN_DATA_FAILURE";
