...
export const GET_KIDS_REQUEST = "GET_DATA_REQUEST";
export const GET_KIDS_SUCCESS = "GET_DATA_SUCCESS";
export const GET_KIDS_FAILURE = "GET_DATA_FAILURE";
...
export const GET_WOMENS_REQUEST = "GET_DATA_REQUEST";
export const GET_WOMENS_SUCCESS = "GET_DATA_SUCCESS";
export const GET_WOMENS_FAILURE = "GET_DATA_FAILURE";


///when clicked on book button on a paclage,this actions are dispatched
export const GET_WOMENS_DATA_REQUEST = "GET_WOMEN_DATA_REQUEST";
export const GET_WOMENS_DATA_SUCCESS = "GET_WOMEN_DATA_SUCCESS";
export const GET_WOMENS_DATA_FAILURE = "GET_WOMEN_DATA_FAILURE";


//satmrngchanegspraveen

export const DELETE_WOMENS_DATA_REQUEST = "DELETE_WOMEN_DATA_REQUEST";
export const DELETE_WOMENS_DATA_SUCCESS = "DELETE_WOMEN_DATA_SUCCESS";
export const DELETE_WOMENS_DATA_FAILURE = "DELETE_WOMEN_DATA_FAILURE";
