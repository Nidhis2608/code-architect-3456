...
export const GET_MENS_REQUEST = "GET_DATA_REQUEST";
export const GET_MENS_SUCCESS = "GET_DATA_SUCCESS";
export const GET_MENS_FAILURE = "GET_DATA_FAILURE";
...
export const DELETE_MENS_DATA_REQUEST = "DELETE_MEN_DATA_REQUEST";
export const DELETE_MENS_DATA_SUCCESS = "DELETE_MEN_DATA_SUCCESS";
export const DELETE_MENS_DATA_FAILURE = "DELETE_MEN_DATA_FAILURE";