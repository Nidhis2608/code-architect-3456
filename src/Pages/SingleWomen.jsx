...
const bookingurl = "https://moke-api-server.onrender.com/Womens"; // Replace with actual booking API URL
// const cartUrl = "YOUR_CART_API_URL"; // Replace with actual cart API URL
// const wishlistUrl = "YOUR_WISHLIST_API_URL"; // Replace with actual wishlist API URL
const url = "https://moke-api-server.onrender.com/Womens"; // Replace with actual API URL
