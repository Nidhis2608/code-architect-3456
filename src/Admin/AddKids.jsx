...
//             try{
//               let res= await axios.post("https://moke-api-server.onrender.com/Kids");
...
//             }
//         }
//         AddKids({image,price,description,title})
...
//             <Button colorScheme='green' onClick={onOpen}>Add Kid's Data</Button>
//         </Flex>
//         <Modal initialFocusRef={initialRef} finalFocusRef={finalRef} isOpen={isOpen} onClose={onClose} size={'xl'}>
//         <ModalOverlay />
//         <ModalContent>
//             <ModalHeader>Add Kid's Data</ModalHeader>
//             <ModalCloseButton />
//             <ModalBody pb={6}>
//             {/* <FormControl>
...
export const AddKids = ({ props }) => {
  ...
  const postData = async (data) => {
    try {
      let res = await axios.post('https://moke-api-server.onrender.com/Kids', data);
      console.log(res.data);
    } catch (error) {
      console.error(error);
      throw error;
