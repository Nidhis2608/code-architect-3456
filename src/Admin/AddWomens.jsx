...
//             try{
//               let res= await axios.post("https://moke-api-server.onrender.com/Womens");
...
//             <Button colorScheme='green' onClick={onOpen}>Add Women's Data</Button>
//         </Flex>
//         <Modal initialFocusRef={initialRef} finalFocusRef={finalRef} isOpen={isOpen} onClose={onClose} size={'xl'}>
//         <ModalOverlay />
//         <ModalContent>
//             <ModalHeader>Add Women's Data</ModalHeader>
//             <ModalCloseButton />
//             <ModalBody pb={6}>
//             <FormControl mt={4}>
...
export const AddWomens = ({ props }) => {
  ...
  const postData = async (data) => {
    try {
      let res = await axios.post('https://moke-api-server.onrender.com/Womens', data);
      console.log(res.data);
    } catch (error) {
      console.error(error);
      throw error;
